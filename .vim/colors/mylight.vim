...
hi Builtin  guifg=#a699ad guibg=NONE gui=NONE
hi BuiltinObj  guifg=#a699ad guibg=NONE gui=NONE
hi BuiltinFunc  guifg=#dad085 guibg=NONE gui=NONE
...
hi Definition guifg=#f8efab guibg=NONE gui=NONE
...
hi ParamName guifg=#7587a6 guibg=NONE gui=NONE
...
hi PreCondition  guifg=#cda869 guibg=NONE gui=NONE
...
hi Storage guifg=#f8efab guibg=NONE gui=NONE
hi StorageClass  guifg=#f9ee98 guibg=NONE gui=NONE
hi String  guifg=#8f9d6a guibg=NONE gui=NONE
hi Support guifg=#a699ad guibg=NONE gui=NONE
hi Superclass guifg=#9b5c23 guibg=NONE gui=italic
...
hi Variable guifg=#8d99b4 guibg=NONE gui=NONE
